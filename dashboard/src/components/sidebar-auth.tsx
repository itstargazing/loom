...
/** Signed-in identity, org switcher (seats), and Account link. */
      ...
      <Show when="signed-in">
        <div className="flex flex-col gap-sm">
            ...
            appearance={{
              elements: {
                ...
                organizationSwitcherTrigger:
                  "w-full justify-between rounded-sm border border-border-soft px-2 py-1.5 text-xs",
              },
            }}
          />
          ...
          <p className="text-[10px] leading-snug text-text-faint">
            Orgs cover team seats. Capture data stays personal per user.
          </p>
        </div>
      </Show>
