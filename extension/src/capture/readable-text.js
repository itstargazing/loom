...
const UNLIKELY_PATTERN = /(^|[\s_-])(nav|menu|sidebar|footer|header|comment|promo|advert|ads?|banner|cookie|newsletter|social|share|related|breadcrumb|pagination|modal|popup)([\s_-]|$)/i;
function isUnlikelyContainer(element) {
